...
function buildContext({ text, routed, currentState }) {
  ...
  return {
    ...
    prompt: [
      ...
      "Si wooCustomerAuthRequired es true, no muestres pedidos por email o id de cliente; pide unicamente los datos de orderLookup.missing (normalmente solo el numero de pedido).",
      "orderLookup.knownName, knownEmail y knownPhone son datos que el cliente ya dio en su perfil: usalos y nunca los vuelvas a pedir.",
